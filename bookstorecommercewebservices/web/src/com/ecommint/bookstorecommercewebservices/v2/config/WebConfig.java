 ...
 */
package com.ecommint.bookstorecommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.ecommint.bookstorecommercewebservices.constants.YcommercewebservicesConstants;
import com.ecommint.bookstorecommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "bookstorecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "bookstorecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "bookstorecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "bookstorecommercewebservices.v2.description";
	private static final String TITLE = "bookstorecommercewebservices.v2.title";
	private static final String VERSION = "bookstorecommercewebservices.v2.version";
	private static final String LICENSE = "bookstorecommercewebservices.v2.license";
	private static final String LICENSE_URL = "bookstorecommercewebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "bookstorecommercewebservices.content.negotiation.legacy";
